...
public class ShipPhysics : MonoBehaviour
{
    ...
    [SerializeField] private GameObject shipModel;
        ...
        private ModifyShipMesh modifyShipMesh;
        ...
        void Start()
        {
            ...
            modifyShipMesh = new ModifyShipMesh(shipModel);
        ...
        void Update()
        {
            ...
            modifyShipMesh.GenerateUnderwaterMesh();

            //Display the under water mesh
            modifyShipMesh.DisplayMesh(underWaterMesh, "UnderWater Mesh", modifyShipMesh.underWaterTriangleData);
        }

        void FixedUpdate()
        {
            //Add forces to the part of the boat that's below the water
            if (modifyShipMesh.underWaterTriangleData.Count > 0)
            {
            Debug.Log("Under water forces added");
                AddUnderWaterForces();
            }
        }
        ...
        {
            //Get all triangles
            List<TriangleData> underWaterTriangleData = modifyShipMesh.underWaterTriangleData;
